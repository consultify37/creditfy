  ...
  return (
    <article className="flex flex-wrap gap-y-10 gap-x-[6rem] mt-10 md:mt-32 justify-between items-center">
      <div className="flex-1">
        <h2 className="text-primary font-bold text-xl mb-6 md:text-xl lg:text-2xl xl:text-3xl">
          Ne diferențiem prin:
        </h2>
        ...
        <div className="flex gap-4 mt-4">
          <Link
            href="/credite" 
            className="bg-primary py-3 text-secondary font-semibold rounded-[28.5px] font-xl px-12 hover:scale-[1.05] transition-all"
          >
            Credite
          </Link>
          <Link
