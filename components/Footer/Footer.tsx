...
import { email, facebook, instagram, phone, tiktok } from "../../utils/constants"
        ...
        <footer className='w-full mt-12 md:mt-24'>
            <div className='flex flex-wrap flex-col justify-between md:flex-row gap-10 px-7 md:px-12'>
                <div className='flex flex-col gap-2 w-full lg:max-w-[20%]'>
                    ...
                    <p className='text-[#333333] text-[14px] md:text-[16px] mt-4'>
                        Creditfy este partenerul tău de încredere în obținerea finanțărilor nerambursabile, oferind soluții personalizate pentru dezvoltarea afacerii tale.
                    </p>
                </div>
                <div className='flex flex-col gap-1 lg:max-w-[20%]'>
                    ...
                    <ul className='list-none flex flex-col gap-1'>
                        ...
                        <li>
                            <Link href='/credite' className='font-semibold text-[#6A6A6A] text-[16px]'>Credite</Link>
                        </li>
                        <li>
                ...
                <div className='flex flex-col gap-1 lg:max-w-[20%]'>
                    ...
                    <ul className='list-none flex flex-col gap-1'>
                        ...
                        <li>
                            <Link href={`tel:${phone}`} className='font-semibold text-[#6A6A6A] text-[16px]'>Număr de telefon: {phone}</Link>
                        </li>
                        <li>
            ...
            <div className='w-full mt-5 text-center px-7 md:px-12'>
                <p className='text-[#6A6A6A] text-[16px] font-normal border-t-[3px] border-ptimary py-4 px-4 md:px-0'>
