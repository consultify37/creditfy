...
const BulletPointsContainer = ({ bulletPoints, setBulletPoints }: Props) => {
  ...
  return (
    <div className='relative'>
      <input 
        className='text-base p-4 rounded-xl border-2 border-primary outline-none w-full pr-[52px] mb-4'
        placeholder='Adaugă un bullet point (max. 4)'
      ...
      { bulletPoints.map((bulletPoint, index) => (
        <div className='relative w-full p-4 flex flex-row justify-between items-center' key={bulletPoint+index}>
