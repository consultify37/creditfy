...
export default function FonduriComponent({ program, index=0, carousel=false }: Props) {
    return(
        ...
        >   
            ...
            <div className="flex flex-col justify-center w-fit lg:max-w-[45%] self-center items-center rounded-2xl relative top-[40px] lg:top-[100px] z-[5] bg-[#260056] py-8 px-8">
