...
const CategoryHeader = ({ category }: Props) => {
    return(
        <section id='category-header' className=''>
            <div className='bg-[#260056] w-full gap-4 rounded-[24px] sm:rounded-[35px] flex flex-col items-center justify-center py-6 md:py-14 relative mx-auto overflow-hidden'>
