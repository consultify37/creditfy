  ...
  const handleCheckout = async (e: any) => {
    ...
    try {
      ...
      const response = await axios.post('https://createcheckoutsession-75cxgdbjwq-ey.a.run.app', {
        ...
        success_url: 'https://www.creditfy.ro/shop/success',
        cancel_url: 'https://www.creditfy.ro/shop/cart'
      })
        ...
        <div className='flex flex-col lg:flex-row w-full'>
          <form onSubmit={handleCheckout} className='flex flex-col lg:w-1/2 lg:pr-16'>
            ...
            { !isLoading ?
              ...
              <ReactLoading type="spin" color="#FF7A00" width={32} height={32} className='mt-6 self-center' />
            }
          </form>
